...
. A criação do FlexVol volume até o tamanho máximo de 300 TIB é suportada usando o Gerenciador de sistema e a CLI do ONTAP a partir do Cloud Volumes ONTAP 9.12.1 P2 e 9.13.0 P2.
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-ha-google-cloud.html["Saiba como o storage funciona em um par de HA do Cloud Volumes ONTAP em execução no Google Cloud"^].
